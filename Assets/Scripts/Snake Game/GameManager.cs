        ...
        {   
            if(Time.time > restart && !evolved)
            {
              ...
              //  speciesTxt.text = "Species: " + species.Count;
                ...
                Evolution.Reproduce(offspringNum);
                ...
                /*                //SPECIATION         
                                ...
                                for(int i = 0; i < snakes.Count; i++)
                                {
                                    ...
                                    if(species.Count == 0)
                                    {
                                        ...
                                        species[0][0].GetComponent<Snake>().boardScript.species = 1;
                                    ...
                                    else if(species.Count > 0 && gen == 2)
                                    {
                                        ...
                                        for(int j = 0; j < species.Count; j++)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                species[j][species[j].Count - 1].GetComponent<Snake>().boardScript.species =
                                                species[j][0].GetComponent<Snake>().boardScript.species;
                                        ...
                                        if(createSpecies)
                                        {
                                           // ++speciesNum;
                                            ...
                                            int highestSpecies = 0;
                                            for(int x = 0; x < species.Count; x++)
                                            {
                                                if(highestSpecies < species[x][0].GetComponent<Snake>().boardScript.species)
                                                {
                                                    highestSpecies = species[x][0].GetComponent<Snake>().boardScript.species;
                                                }
                                            }
                                            species[species.Count - 1][0].GetComponent<Snake>().boardScript.species = highestSpecies;
                                           // species[species.Count - 1][0].GetComponent<Snake>().boardScript.species = species.Count;
                                    ...
                                    else if(species.Count > 0 && gen > 2)
                                    {
                                        ...
                                        for(int j = 0; j < species.Count; j++)
                                        {
                                            ...
                                            int rnd = Random.Range(0, species[j].Count);
                                            //             print(NetworkManager.instance.CompatabilityDistance(snakes[i].GetComponent<Snake>().brain.genomeConnectionGenes,
                                            //             species[j][rnd].GetComponent<Snake>().brain.genomeConnectionGenes) + " species: " +j);
                                            if (species[j].Count > 0)
                                            {
                                                if (NetworkManager.instance.CompatabilityDistance(snakes[i].GetComponent<Snake>().brain.genomeConnectionGenes,
                                                species[j][rnd].GetComponent<Snake>().brain.genomeConnectionGenes) >= compat_threshhold)
                                                {
                                                ...
                                                else
                                                {
                                                    ...
                                                    childSpecies[j][childSpecies[j].Count-1].GetComponent<Snake>().boardScript.species =
                                                        childSpecies[j][0].GetComponent<Snake>().boardScript.species;
                                                    // snakes[i].GetComponent<Snake>().boardScript.species = temp;
                                                    //listOfBoards[i].GetComponent<Board>().species = temp;
                                                    break;
                                                }
                                        ...
                                        if(createSpecies)
                                        {
                                           ...
                                           // ++speciesNum;
                                            ...
                                            species[species.Count - 1][0].GetComponent<Snake>().boardScript.species = highestSpecies;
                                             ...
                                             highestSpecies = 0;
                                            for (int x = 0; x < childSpecies.Count; x++)
                                            {
                                                if (childSpecies[x].Count > 0 && highestSpecies < childSpecies[x][0].GetComponent<Snake>().boardScript.species)
                                                {
                                                    highestSpecies = childSpecies[x][0].GetComponent<Snake>().boardScript.species;
                                                }
                                            }
                                            childSpecies[childSpecies.Count - 1][0].GetComponent<Snake>().boardScript.species = highestSpecies;
                                            //  species[species.Count - 1][0].GetComponent<Snake>().boardScript.species = species.Count;
                                            //  childSpecies[childSpecies.Count - 1][0].GetComponent<Snake>().boardScript.species = childSpecies.Count;
